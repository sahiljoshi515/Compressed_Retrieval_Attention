...
transformer_configs = {
    ...
    "Llama-2-7b-chat-hf": dict(block_size=4096, vocab_size=32000, n_layer=1, n_head=32, dim=4096, rope_base=10000),
...
class Attention(nn.Module):
    ...
    def sparse_forward(
        ...
        # (Disabled: placeholder that always picked the last K positions.)
        # -------------------------
